...
Range Consolidation — ADX below 25, RSI 40–60, price between clear S/R levels
...
### `R06-S01` — Range fade (upper boundary) — Range Consolidation

Fade local premium in Range Consolidation toward equilibrium; stat-arb / STIR desk style mean reversion.

**References:** Avellaneda & Lee (2010) statistical arbitrage mean reversion — Potter & Bouchaud short-horizon MR in ranges

### `R06-S02` — Range fade (lower boundary) — Range Consolidation

Buy discount in Range Consolidation when process shows stationary range behavior.

**References:** Same MR foundations as upper fade — Band-trading practitioner risk: partial exits into midline

### `R06-S03` — Z-score oscillation — Range Consolidation

Enter on standardized deviation from local mean under Range Consolidation; pairs / basket desks analogue.

**References:** Pole & critic: Ornstein–Uhlenbeck-inspired OU trading heuristics — Gatev, Goetzmann & Rouwenhorst (2006) pairs trading

### `R06-S04` — Premium/discount equilibrium trade — Range Consolidation

Scale toward 50% dealing range equilibrium in Range Consolidation (ICT-style auction framing; discretionary).
...
If you ran `_write_regime_docs.py`, extra notes may exist under project folder `Q3 — Range Low Volatility/regimes/r06.md` when this ID is in that quadrant’s list.
