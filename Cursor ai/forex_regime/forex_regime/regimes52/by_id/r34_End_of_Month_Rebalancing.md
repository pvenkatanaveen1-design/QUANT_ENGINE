# Regime 34 — End of Month Rebalancing
...
End of Month Rebalancing — benchmark flow schedules; predictable directional pressure windows
...
### `R34-S01` — Range fade (upper boundary) — End of Month Rebalancing

Fade local premium in End of Month Rebalancing toward equilibrium; stat-arb / STIR desk style mean reversion.

**References:** Avellaneda & Lee (2010) statistical arbitrage mean reversion — Potter & Bouchaud short-horizon MR in ranges

### `R34-S02` — Range fade (lower boundary) — End of Month Rebalancing

Buy discount in End of Month Rebalancing when process shows stationary range behavior.

**References:** Same MR foundations as upper fade — Band-trading practitioner risk: partial exits into midline

### `R34-S03` — Z-score oscillation — End of Month Rebalancing

Enter on standardized deviation from local mean under End of Month Rebalancing; pairs / basket desks analogue.

**References:** Pole & critic: Ornstein–Uhlenbeck-inspired OU trading heuristics — Gatev, Goetzmann & Rouwenhorst (2006) pairs trading

### `R34-S04` — Premium/discount equilibrium trade — End of Month Rebalancing

Scale toward 50% dealing range equilibrium in End of Month Rebalancing (ICT-style auction framing; discretionary).
...
If you ran `_write_regime_docs.py`, extra notes may exist under project folder `Q3 — Range Low Volatility/regimes/r34.md` when this ID is in that quadrant’s list.
